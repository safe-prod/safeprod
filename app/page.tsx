...
export default function Page() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <input className="sticky top-4 backdrop-blur-sm mb-4 border-none rounded-lg p-2 bg-gray-50 text-red-800 text-xl font-bold" placeholder="Search..." />
      {items.map((_, index) => (
        <div key={index} className="p-2 mb-2 rounded-lg flex flex-col bg-gray-200">
          ...
          <div className="flex flex-row grow font-bold text-sm text-red-600">
