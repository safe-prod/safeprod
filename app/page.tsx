...
export default function Page() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {items.map((_, index) => (
        <div key={index} className="p-2 mb-2 rounded-lg flex flex-col border border-gray-100">
      ...
      <div className="fixed bottom-0 flex flex-col left-0 right-0 ml-2 mr-2">
        <div className="backdrop-blur-md bg-white/30 p-2 rounded-lg flex flex-col border border-gray-100">
          <div className="mb-2 flex flex-row grow font-bold text-xl">
            <input type="text" className="w-1/2 text-black border-b ml-2 border-red-900" placeholder="Investor" />
